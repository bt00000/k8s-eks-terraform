...
# Create EKS Cluster (With Only Private Subnets) & Security Group
resource "aws_eks_cluster" "eks" {
  ...
  vpc_config {
    ...
    security_group_ids = [aws_security_group.eks_cluster_sg.id] # Add security group
  }
...
resource "aws_eks_node_group" "node_group" {
  ...
  tags = {
    "Name"                                 = "eks-node-group"
    "kubernetes.io/cluster/my-eks-cluster" = "owned" # Required for auto-scaling
  }
}
